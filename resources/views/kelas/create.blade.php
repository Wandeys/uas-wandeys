        ...
        <form action="{{ route('kelas.store') }}" method="post" class="form">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" required value="{{ old('name') }}" placeholder="e.g. Kelas A">
                    @error('name')
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control weight-input @error('weight_attendance') is-invalid @enderror" type="number" step="0.01" id="weight_attendance" name="weight_attendance" required min="0" max="100" value="{{ old('weight_attendance', 10.00) }}">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control weight-input @error('weight_task') is-invalid @enderror" type="number" step="0.01" id="weight_task" name="weight_task" required min="0" max="100" value="{{ old('weight_task', 20.00) }}">
                    @error('weight_task')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control weight-input @error('weight_uts') is-invalid @enderror" type="number" step="0.01" id="weight_uts" name="weight_uts" required min="0" max="100" value="{{ old('weight_uts', 30.00) }}">
                    @error('weight_uts')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control weight-input @error('weight_uas') is-invalid @enderror" type="number" step="0.01" id="weight_uas" name="weight_uas" required min="0" max="100" value="{{ old('weight_uas', 40.00) }}">
                    @error('weight_uas')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
