<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('tahun-akademik.store') }}" method="post" class="form">
            @csrf

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="year" class="form-label required">Tahun Ajaran</label>
                    <input class="form-control @error('year') is-invalid @enderror" type="text" id="year" name="year" required value="{{ old('year') }}" placeholder="e.g. 2025/2026">
                    @error('year')
